...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
Button::Button(int pX,int pY,int pWidth,int pHeight,const char* pText):mText(NULL)
{
	mRect.FromX = pX;
	mRect.FromY = pY;
	mRect.ToX = pX + pWidth;
...
void Button::SetTextf(const char* pFmt,...)
{
	char buf[1024];	
	va_list args;
	va_start(args, pFmt);
...
void Button::SetColour(uint8_t pRed,uint8_t pGreen,uint8_t pBlue)
{
...
void Button::SetLightColour(uint8_t pRed,uint8_t pGreen,uint8_t pBlue)
{
	mLightColour.r = pRed;
...
void Button::SetFillColour(uint8_t pRed,uint8_t pGreen,uint8_t pBlue)
{
	mFillColour.r = pRed;
...
void Button::SetDarkColour(uint8_t pRed,uint8_t pGreen,uint8_t pBlue)
{
	mDarkColour.r = pRed;
...
void Button::SetTextColour(uint8_t pRed,uint8_t pGreen,uint8_t pBlue)
{
	mTextColour.r = pRed;
...
void Button::SetTextPressedColour(uint8_t pRed,uint8_t pGreen,uint8_t pBlue)
{
